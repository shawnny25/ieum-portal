...
export const PROGRAM = "2027 국제나눔 파트너십 지원사업";
export const TEAM = "파트너십지원부";         // 운영 부서명 (화면 문구·메일 서명)
export const PROGRAM_YEAR = 2027;             // 사업연도. 차년도 계산 기준 (선발연도 = PROGRAM_YEAR → 1차년도)
export const CUR_YEAR = PROGRAM_YEAR;
