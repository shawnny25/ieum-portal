...
export let CONSULT_TYPES = [
  ...
  { key: "opt", label: "선택컨설팅", required: false, slots: days(["2026.10.13", "2026.10.14", "2026.10.15"]) },
];
...
export function applySettings(s) {
  ...
  if (Array.isArray(s.consult_types) && s.consult_types.length)
    CONSULT_TYPES = s.consult_types.map((t) => ({ ...t, slots: t.slots || days(t.dates || []) }));   // 구버전(dates) 호환
