...
// kind: static(자동 표시) | text | textarea | multi(다중 선택 + 기타 주관식). max = 글자 수 상한. section = 구역 제목.
export const OPT_FIELDS = [
  { key: "org", label: "기관명", kind: "static", section: "1) 신청기관 기본정보" },
  { key: "manager", label: "담당자명", kind: "text", required: true, prefill: "manager" },
  { key: "attendees", label: "기관측 컨설팅 참석자명", kind: "text", required: true, placeholder: "예: 홍길동 팀장, 김민수 담당" },
  { key: "field", label: "컨설팅 희망분야", kind: "multi", required: true, section: "2) 컨설팅 신청내용",
    options: ["협동조합", "소득증대", "직업훈련", "젠더", "농업", "교육", "식수위생", "국제보건", "장애포괄", "사회적경제"], other: true },
  { key: "reason", label: "컨설팅 신청 사유", kind: "textarea", required: true, max: 500, placeholder: "컨설팅이 필요한 배경과 목적을 500자 이내로 적어 주세요." },
  { key: "question", label: "세부 질의사항", kind: "textarea", required: true, max: 1000, rows: 6,
    placeholder: "컨설턴트가 사전에 준비할 수 있도록 구체적으로 적어 주세요. 예) 현재 겪는 문제, 시도해 본 방법, 궁금한 점, 참고 자료 (1000자 이내)" },
];
export const EXPERT_PREF_HINT = "희망하는 컨설턴트가 있으면 성함을 적어 주세요. 없으면 비워두시면 사무국에서 추천하여 배정합니다.";
