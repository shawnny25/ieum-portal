...
export let REPORT_DUE = "2026.09.18";         // 중간보고서 제출 마감
...
export function currentSettings() {
  return { program: PROGRAM, team: TEAM, program_year: PROGRAM_YEAR, report_due: REPORT_DUE, fix_days: FIX_DAYS, cap: CAP,
...
export function applySettings(s) {
  ...
  if (s.report_due) REPORT_DUE = s.report_due;
