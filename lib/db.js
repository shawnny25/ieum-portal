...
export async function loadDb() {
  ...
  const [orgsRaw, profiles, subsRaw, versions, feedbacks, availRaw, confirmsRaw, preRaw, budgetsRaw, docs, reports, alerts, logs, roadmapRaw, expertAvailRaw, expertNotesRaw] =
    await Promise.all([q("orgs"), q("profiles"), q("submissions", "org_id"), q("versions"), q("feedbacks"), q("avail", "date"),
      q("confirms", "date"), q("pre", "org_id"), q("budgets"), q("docs"), q("reports"), q("alerts"), q("logs"), q("roadmap", "m"), q("expert_avail", "date"), q("expert_notes", "expert_id")]);
